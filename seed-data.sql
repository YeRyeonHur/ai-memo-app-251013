...
-- 2. 아래 YOUR_USER_ID를 실제 사용자 UUID로 변경
-- 3. 쿼리 실행
...
-- 3. 음성 메모 활용법
('YOUR_USER_ID', '🎙️ 음성 메모 활용법 (향후 제공 예정)',
...
-- SELECT title, created_at FROM notes WHERE user_id = 'YOUR_USER_ID' ORDER BY created_at DESC;
